...
npm run preview # dist'i yerel sunucuda aç
```

Build `base: './'` ve `HashRouter` ile yapılandırıldığı için `dist/index.html`
dosyasına çift tıklayarak da (dosya sistemi üzerinden) açılabilir.
